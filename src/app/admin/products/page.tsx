...
export default async function AdminProductsPage() {
  ...
  return <><div><p className="text-sm font-semibold uppercase tracking-[0.12em] text-brand">Catalog</p><h1 className="mt-1 text-3xl font-bold">Products</h1></div><div className="mt-6"><ProductCatalog categories={clientCategories} /></div></>;
}
