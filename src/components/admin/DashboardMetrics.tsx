...
export function DashboardMetrics() {
  ...
  useEffect(() => { fetch(`/api/admin/reports?view=dashboard&start=${start}&end=${end}`).then((response) => response.ok ? response.json() : null).then(setData).catch(() => setData(null)); }, [start, end]);
