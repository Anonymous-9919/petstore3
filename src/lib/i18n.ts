const messages: Record<string, { en: string; ar: string }> = {
  ...
  pickupFrom: { en: "Pickup from", ar: "استلام من" },
  pickupTime: { en: "Pick up time", ar: "وقت الاستلام" },
  directions: { en: "Directions", ar: "الاتجاهات" },
  customize: { en: "Customize", ar: "تخصيص" },
  pricePrefix: { en: "Price: ", ar: "السعر: " },
  save: { en: "SAVE", ar: "حفظ" },
  ...
  scheduleForLater: { en: "Schedule for later", ar: "استلام لاحقا" },
